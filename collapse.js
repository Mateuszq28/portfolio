...
// with animation
let coll_ = document.getElementsByClassName("red_mor");
var i;
...
for (i = 0; i < coll_.length; i++) {
  coll_[i].addEventListener("click", function() {
    let coll = this
    let hid_but = coll.nextElementSibling;
    let content = hid_but.nextElementSibling;
...
let hid_but_ = document.getElementsByClassName("hid_but_gone");
var i;
...
for (i = 0; i < hid_but_.length; i++) {
  hid_but_[i].addEventListener("click", function() {
    let coll = this.parentNode.firstElementChild;
    let hid_but = this;
    let content = hid_but.nextElementSibling;
    // var hid_but2 = content.nextElementSibling;
...
let hid_but2_ = document.getElementsByClassName("hid_but2");
var i;
...
for (i = 0; i < hid_but2_.length; i++) {
  hid_but2_[i].addEventListener("click", function() {
    let hid_but2 = this;
    let coll = hid_but2.parentNode.parentNode.firstElementChild;
    let hid_but = coll.nextElementSibling;
    let content = hid_but.nextElementSibling;
